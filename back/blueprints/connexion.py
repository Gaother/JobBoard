...
@CONNEX.route("/connex", methods=["POST", "OPTIONS", "HEAD"])
def connexion():
    """Connexion route for user

    Returns:
        json: return a token and IsAdmin
    """
    ...
    man =  Manager()
    token = man.connexion(form_request["email"], form_request["passwrd"])
