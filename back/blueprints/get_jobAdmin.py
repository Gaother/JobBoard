...
import jwt
GETJOBADMIN = Blueprint("getjobAd", __name__)


@GETJOBADMIN.route("/getjobAd", methods=["GET", "OPTIONS", "HEAD"])
def get_user():
    """route for get all user in database

    Returns:
        tab[json]: tab with all user 
    """
